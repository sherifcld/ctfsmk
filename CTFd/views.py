    ...
    if not config.is_setup():
        ...
        if request.method == "POST":
            ...
            index_content = (
                ...
                '<h1>Welcome to SMK NEGERI 1 TANJUNG LAGO CTF</h1>'
                '<p class="lead">Web dibuat oleh SMK 1 TANJUNG LAGO</p>'
                '<p>Hubungi kami di <a href="https://t.me/she0rif">t.me/she0rif</a></p>'
                '<p>Kunjungi website kami: <a href="https://smkn1tanjunglago.sch.id">smkn1tanjunglago.sch.id</a></p>'
                '</div>'
                '</div>'
            )
            page = Pages(title=ctf_name, route="index", content=index_content, draft=False)
